...
# Configuration
repo_path = "C:/Users/GAMER/Instagram-Data-Visualizer"  # Update with the path to your repository
file_name = "contribution_file.txt"  # A new file to modify in the repo
start_date = "2024-09-01"  # Start date for contributions (last three months)
end_date = "2024-12-01"  # End date for contributions
commits_per_day = 1  # Number of commits to make per day
